    ...
    <section className="w-full h-full flex flex-col items-start gap-y-4 py-6 basic-container px-2 sm:px-2 md:px-4 xl:px-0">
      ...
      <div className="max-w-[750px] mx-auto flex flex-col items-start gap-y-4 w-full">
        <p className="w-full text-left">
          online3help is a metadata-search engine, which mean that different
          search machines of online3help search in more search engines on the
          internet. The results that are displayed by online3help as result of a
          search command of a user, originate from other search engines.
          online3help shows the source of each result in its result list. It is
          possible that online3help shows in the search results direct links to
          ...
          can be found and accessed by using the Website, online3help does not
          ...
          copy and / or download of this material. online3help is never
        ...
        <p className="w-full text-left">
          online3help offers a shopping experience as easy as possible. We have
          relationships with various companies, organizations and entities whose
          products or services may be listed on online3help. If any of those
          products or services are purchased through the links on this website,
          then online3help may be compensated. It may happen that shops
